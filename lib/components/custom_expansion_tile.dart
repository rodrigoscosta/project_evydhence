...
class CustomExpansionTile extends StatefulWidget {
  ...
  /// Cor do ícone de [trailing].
  ///
  /// Útil quando precisa customizar apenas a cor em
  /// vez do ícone padrão como um todo.
  final Color trailingColor;

  /// Lista de widgets à esquerda do [trailing].
  ///
  /// Normalmente são [IconButton]'s.
